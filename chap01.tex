...
\footnotetext{In continuous clustering methods, there is no notion of merging or splitting in each step of~the algorithm. Instead, ``a continuous scale of successively coarser cluster sets" \citep{Garcke00} is created.}
